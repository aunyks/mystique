...
const isFakeDetached = FakeSymbol('is "detached" for our purposes');
...
var helpers$1 = ({
  ...
  CreateIterResultObject: helpers_5,
  IsFiniteNonNegativeNumber: helpers_6,
  IsNonNegativeNumber: helpers_7,
  Call: helpers_8,
  CreateAlgorithmFromUnderlyingMethod: helpers_9,
  InvokeOrNoop: helpers_10,
  PromiseCall: helpers_11,
  TransferArrayBuffer: helpers_12,
  IsDetachedBuffer: helpers_13,
  ValidateAndNormalizeHighWaterMark: helpers_14,
  MakeSizeAlgorithmFromSizeFunction: helpers_15
});
...
const AbortSteps = FakeSymbol('[[AbortSteps]]');
const ErrorSteps = FakeSymbol('[[ErrorSteps]]');
...
const { ArrayBufferCopy, CreateAlgorithmFromUnderlyingMethod: CreateAlgorithmFromUnderlyingMethod$1, CreateIterResultObject, IsFiniteNonNegativeNumber: IsFiniteNonNegativeNumber$1,
        InvokeOrNoop: InvokeOrNoop$1, IsDetachedBuffer, TransferArrayBuffer, ValidateAndNormalizeHighWaterMark: ValidateAndNormalizeHighWaterMark$1, IsNonNegativeNumber: IsNonNegativeNumber$1,
...
const CancelSteps = FakeSymbol('[[CancelSteps]]');
const PullSteps = FakeSymbol('[[PullSteps]]');
...
//# sourceMappingURL=ponyfill.es6.cjs.js.map
